...
public final class Pearload {
    ...
    public void onEntityJoin(@NotNull EntityJoinWorldEvent event) {
        ...
        handleEntityForceLoadChange(new ChunkPos(entity.blockPosition()), entity.getUUID(), entity, true);
    }

    public void onEntityLeave(@NotNull EntityLeaveWorldEvent event) {
        Entity entity = event.getEntity();
        handleEntityForceLoadChange(new ChunkPos(entity.blockPosition()), entity.getUUID(), entity, false);
    }
